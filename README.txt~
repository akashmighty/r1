This is a Simple Nodejs application.Created first Express application,how properly we can configure it.
...
This application connects to mongodb(local host).A mongoose schema,model has been created.A json file is created to define schema.A document has been posted through the command line.It will be updated in mongodb.You can check the users list using localhost:3000/users.
